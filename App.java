...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Customer customer1 = new Customer("John","Smith","JohnSmith","ilike360");
        Customer customer2 = new Customer("Tammy","Charles","TamTam","iceCream");
        Customer customer3 = new Customer("A","Person","username","1234");
        
        // preset employees
        Employee employee1 = new Employee("Nicole","Ang-Wanek",10,"ceo240","123456");
